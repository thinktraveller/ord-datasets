...
| 项目 | 内容 |
|---|---|
| 主数据文件 | [`chemrxiv-imidazole-c-h-arylation-yield-percent-dataset.csv`](chemrxiv-imidazole-c-h-arylation-yield-percent-dataset.csv) |
| 纳入 / 排除 / 输入记录 | 1,529 / 7 / 1,536 |
| 标签列 | `yield_percent` |
...
| 文件 | 用途 |
|---|---|
| [`chemrxiv-imidazole-c-h-arylation-yield-percent-dataset.csv`](chemrxiv-imidazole-c-h-arylation-yield-percent-dataset.csv) | 可直接用于分析或建模的主表；每行是一条纳入的反应。 |
