...
| F2 | resolved | Public HF Dataset `thinktraveller/ord-processed-reaction-corpus` was created, its exact 224-file candidate uploaded, and tag `v0.2.0-corpus-preview-1` frozen to `260cde0…`. | A fresh download of the tagged commit passed 205/205 SHA-256 and full validation with 0 blocking checks; root `930a9111…563bc663`. See steps 33–34 full-corpus reports. |
